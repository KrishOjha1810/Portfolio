        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Tomato"
              description="Tomato is a fully responsive food delivery website crafted with the MERN stack, featuring a visually stunning user interface and an exceptional user experience. Designed with seamless navigation in mind, the site allows users to browse menus, place orders, and manage their accounts effortlessly. The application incorporates user authentication and authorization for secure access and personalized interactions. Additionally, it integrates Stripe for a smooth payment processing experience, ensuring that transactions are quick and reliable. The project is built using the MVC architecture, promoting a clean and organized code structure that enhances maintainability and scalability.."
